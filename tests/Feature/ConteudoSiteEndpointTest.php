...
test('public conteudo-site endpoint returns seeded data shape', function () {
    ...
    Preco::create(['secao' => 'home', 'servico' => 'A', 'valor' => '10€', 'nota' => null, 'ordem' => 1]);
    Preco::create(['secao' => 'precario', 'servico' => 'B', 'valor' => '20€', 'nota' => 'nota', 'ordem' => 1]);
    ...
    $response->assertJson([
        ...
        'precosHome' => [['servico' => 'A', 'valor' => '10€', 'nota' => null]],
        'precarioAreas' => [['servico' => 'B', 'valor' => '20€', 'nota' => 'nota']],
    ]);
});
